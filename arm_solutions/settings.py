"""
Django settings for arm_solutions project.
...
ROOT_URLCONF = 'arm_solutions.urls'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'index.context_processors.canonical_url',
            ],
        },
    },
]

WSGI_APPLICATION = 'arm_solutions.wsgi.application'
